  ...
  return (
    <main className="min-h-screen bg-transparent">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl items-center justify-center px-4 py-6 sm:px-6 sm:py-10">
        <div className="flex min-h-[82vh] w-full max-w-6xl items-center justify-center bg-transparent p-5 sm:p-8 md:p-10">
          <div className="group relative w-full max-w-4xl">
            ...
            <section className="relative z-20 mt-6 w-full overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl ring-1 ring-inset ring-white/55 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-2xl">
              <div className="h-3 border-b border-zinc-300 bg-zinc-200/95">
                <div className="mx-auto flex h-full w-full items-center justify-between px-5 sm:px-8">
