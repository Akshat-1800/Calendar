...
export default function RangeDeleteConfirmModal({ open, onCancel, onConfirm }) {
  ...
  return createPortal(
    ...
    >
      <button
        type="button"
        aria-label="Close delete range confirmation"
        onClick={onCancel}
      ...
      <section
        role="dialog"
        aria-modal="true"
        aria-label="Delete range confirmation"
        className={cn(
      ...
      >
        <h3 className="text-lg font-semibold text-zinc-900">Delete Range</h3>
